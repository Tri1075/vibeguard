/**
 * The diagnose skill — a disciplined loop for hard bugs and performance
 * regressions: evidence before edits, one hypothesis at a time.
 * Inspired by Matt Pocock's `diagnose` (github.com/mattpocock/skills, MIT).
 */

export function diagnoseSkillMarkdown(): string {
  return [
    '---',
    'name: vibeguard-diagnose',
