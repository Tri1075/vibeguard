/**
 * The tdd skill — red-green-refactor, one vertical slice at a time. The
 * execution end of the planning pipeline; pairs naturally with driftguard,
 * which catches any weakened or deleted test as drift.
 * Inspired by Matt Pocock's `tdd` (github.com/mattpocock/skills, MIT).
 */

export function tddSkillMarkdown(): string {
  return [
    '---',
    'name: vibeguard-tdd',
