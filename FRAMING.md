...
| --- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| 1   | **modules-small**  | Modules ≤ 200 code lines, one nameable responsibility each. **Split BEFORE the limit** (at the warning). Never raise the limit yourself — owner decision. The law teaches _how_ to split: by responsibility, never by arbitrary size.                                                             | code-line count per file: warn ≥ 160, red ≥ 200; catch-all module names (`utils`, `helpers`, `misc`) flagged                                                                                                                                                                                                                       | ✅                    |
